...
public class LineReader implements Iterable<String>, Closeable {
     ...
     * 
     * <p>
     * Uses a {@link FileReader} to read the file.
     * 
     * @param file
     *            Path to file with lines to read.
     ...
     * 
     * @param stream
     *            The {@link Reader} containing the lines to read.
     */
     ...
     * {@link Iterator#hasNext()} returns false, so closing it manually after
     * using a for loop shouldn't be necessary.
     * 
